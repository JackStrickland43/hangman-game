// Imports the images from the directory
...
// Exports the images as an array
export default [state1, state2, state3, state4, state5, state6, state7, state8, state9, state10, state11]
